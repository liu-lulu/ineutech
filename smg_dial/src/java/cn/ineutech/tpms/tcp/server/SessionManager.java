...
public class SessionManager {
	...
	//测试人员座位号信息
	private Map<Integer, String> noInfo;
	...
	public SessionManager() {
		...
		this.noInfo = new HashMap<Integer, String>();
	}
	...
	public Map<Integer, String> getNoInfo() {
		return noInfo;
	}

	public void setNoInfo(Map<Integer, String> noInfo) {
		this.noInfo = noInfo;
	}
	 ...
	 * 座位号变更
	 */
	public void noChange(int userId, String no){
		this.noInfo.put(userId, no);
	}
