...
public class JPushUtil {
	...
	public static boolean pushMsg2AndroidAndIOS(String app_key, String master_secret, String title, String content, String key,
			String jsonValue) throws APIConnectionException, APIRequestException {

		JPushClient jpushClient = new JPushClient(master_secret, app_key);

		PushPayload payload = buildPushMsg(title, content, key, jsonValue);
	...
	private static PushPayload buildPushMsg(String title, String content, String key, String jsonValue) {
