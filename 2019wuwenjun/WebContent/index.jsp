...
<body class="login-bg" >
    ...
    <div class="form-group">
        ...
        <div class="form-item">
            ...
            <input id="username" name="username" type="text" placeholder="请输入账号" style="width:90%;">
        </div>
        <div class="form-item">
            <label for="password">
                <img src="img/password.png" alt="">
            </label>
            <input id="password" name="password" type="password" placeholder="请输入密码" style="width:90%;">
        </div>
    </div>
