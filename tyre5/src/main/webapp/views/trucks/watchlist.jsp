...
<form action="../trucks/watchlist.do" method="get" class="form-inline">
										...
										<tr>
										   ...
										   <td class="td-normal">No</td>
											...
											<td>
												 ...
												 <button type="button" class="btn btn-info" onclick="fasheqipos('${trucksWatchVO.dtu_id}')">查看分布图</button> 
												 </c:if>
												 <a class="btn btn-info" style="color: #FFFFFF;" href="../device/map.do?s=${trucksWatchVO.longitude},${trucksWatchVO.latitude}" target="_blank">定位</a>
												 <c:choose>
										             <c:when test="${trucksWatchVO.id==null}">
										                <a class="btn btn-info" style="color: #FFFFFF;" href="../trucks/truckslistbybind.do?dtu_id=${trucksWatchVO.dtu_id}&phone=${trucksWatchVO.phone}" target="_blank">绑定</a>
										             </c:when>
										             <c:otherwise>
	...
	<script type="text/javascript" src="../js/kkbc/trucks/watchlist.js"></script>
