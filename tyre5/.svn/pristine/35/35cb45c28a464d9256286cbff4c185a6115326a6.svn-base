...
* float包数据
**/
public class DeviceFloat 
{	
	/**
	 * 表名
	 */
	public static final String TB_N="device_float";
	private Long id;
	...
	private String yali_set;
	private String wendu_yali_value;
	...
	public String getYali_set() {
		return yali_set;
	}
	public void setYali_set(String yali_set) {
		this.yali_set = yali_set;
	}
	public String getWendu_yali_value() {
		return wendu_yali_value;
	}
	public void setWendu_yali_value(String wendu_yali_value) {
