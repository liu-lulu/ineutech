...
<form action="../trucks/truckslistbybind.do" method="get" class="form-inline">
 ...
 <input type="hidden" name="phone" value='${phone}'>
		   ...
		   <button type="submit" class="btn btn-primary btn-sm" style="width:60px;">查找</button>
                        ...
                        <div class="table-list content-item">
							...
							<header class="panel-heading"> 
<form action="../trucks/trucksbind.do" method="post" class="form-inline" onsubmit="return false;" id="trucksbindform">
           <input type="hidden" name="dtu_id" value="${dtu_id}">
	...
	<script type="text/javascript" src="../js/kkbc/trucks/truckslistbybind.js"></script>
