...
public class UUIDGenerator {
	...
	public static String generate() {
		return String.valueOf(new StringBuffer(36).append(format(getIP())).append(sep).append(format(getJVM()))
				.append(sep).append(format(getHiTime())).append(sep).append(format(getLoTime())).append(sep)
	...
	public static void main(String args[]) {
		...
		System.out.println(UUIDGenerator.generateAuthKey());
	}
}
