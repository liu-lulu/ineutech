...
public class Trucks {
	...
	private Integer last_driving_record_id;
	...
	public Double getMabiao_ruku() {
		return mabiao_ruku;
	}

	public void setMabiao_ruku(Double mabiao_ruku) {
		this.mabiao_ruku = mabiao_ruku;
	}
	...
	public Integer getLast_driving_record_id() {
		return last_driving_record_id;
	}

	public void setLast_driving_record_id(Integer last_driving_record_id) {
		this.last_driving_record_id = last_driving_record_id;
	}
