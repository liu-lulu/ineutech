...
<script src="<%=path%>/js/jquery-1.11.0.min.js"></script>
 <script src="<%=path%>/js/hardware/common/error.js"></script>
 <script type="text/javascript">
 window.localDomain="<%=path%>/user/goLogin.htm";
 </script>
<title>哎呀…太不给力</title>
...
<div class="bg">
	<div class="cont">
		...
		<h2>哎呀…太不给力了，<span id="totalSecond">10</span>秒后带您回家<c:if test='${errorMessage!=null&&errorMessage!=""}'>(${errorMessage})</c:if></h2>
		<div class="c2"><a href="<%=path%>/user/goLogin.htm" class="home">返回</a></div>
	</div>
</div>
</body>
</html>