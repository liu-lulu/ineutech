  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="mt-30px mb-30px">
        <div class="container-fluid">
          <div class="row">
          	<c:if test="${employee.role==3 }">
          	 <div class="col-lg-4 col-md-12" id="groupvisitinfo">
              <div id="group-feeds" class="card updates daily-feeds">
                <div id="feeds-header" class="card-header d-flex justify-content-between align-items-center">
                  <h2 class="h5 display"><a  href="#group-box" onclick="showAllEmployee()">小组 </a></h2>
                  <div class="right-column">
                    <a data-toggle="collapse" data-parent="#group-feeds" href="#group-box" aria-expanded="true" aria-controls="feeds-box"><i class="fa fa-angle-down"></i></a>
                  </div>
                </div>
                <div id="group-box" role="tabpanel" class="collapse show" style="max-height: 750px;overflow-y: auto;">
                	<div class="panel-group" id="accordion">
                		<c:forEach var="group" items="${groups }">
						<div class="panel panel-success">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" onclick="groupvisit(${group.key.employee_id})"
									   href="#"><%-- href="#collapsevisit_${group.key.employee_id}" --%>
										${group.key.employee_name}
									</a>
								</h4>
							</div>
							<div id="collapsevisit_${group.key.employee_id}" class="panel-collapse collapse">
								<div class="panel-body">
									<c:forEach var="visit" items="${group.value }">
									<div class="row" style="display:flex;">
									<div class="col" style="text-align:right">${visit.purpose }&nbsp;&nbsp;:</div><div class="col" style="text-align:left">${visit.purpose_count }</div>
									</div>
									</c:forEach>
								</div>
							</div>
            ...
            <div class="col-lg-4 col-md-12" id="employeeinfo">
              <!-- Daily Feed Widget-->
                      ...
                      <c:forEach var="employee" items="${employees }">
                        ...
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="${pageContext.request.contextPath}/img/user.png" alt="person" class="img-fluid rounded-circle"></a>
                            <div class="content"><strong><label style="margin-bottom:0;" name="employee_name_${employee.leader_id }">${employee.employee_name }</label></strong><small>业务员 </small>
            ...
            <div class="col-lg-4 col-md-12" id="visitDiv" style="display:none;">
              <!-- Daily Feed Widget-->
            ...
            <div class="col-lg-4 col-md-12" id="curDateVisit">
                    ...
                    <li>
                      <div style="display:flex;">
                        ...
                        <div class="col-9 content"><strong>${curDateRecord.purpose }</strong>
                          <p>${curDateRecord.employee.employee_name }拜访了${fn:substring(curDateRecord.client.client_name, 0, 1)}**</p>
                        </div>
                      </div>
                    </li>
                  </c:forEach>
	...
	String.prototype.replaceAll  = function(s1,s2){     
		...
		function visitHide(){
			if($("#groupvisitinfo").length>0){
				$("#groupvisitinfo").show();
				$("div[id^='collapsevisit_']").collapse('hide');
				$("#employeeName").val("");
				$("label[name^='employee_name_']").each(function() {
							...
							var dd="<dd class='pos-right clearfix'>"+
									...
									"<div class='events' style='float: left;'>"+
										"<div class='events-header' style='float: left;width: 100%;'>"+
											"<div style='float: left;'>拜访了"+clientName.substring(0,1)+"**（事宜:"+visitRecord[i].purpose+"）"+wechatContent+"<br>"+allvoice+"</div>"+
											imgInfo+
										"</div>"+
		...
		function groupvisit(groupId){
			
			$("div[id^='collapsevisit_']").not($("#collapsevisit_"+groupId)).each(function(){
				$(this).collapse('hide');
			});
			
			if($("#collapsevisit_"+groupId).hasClass('show')){
				$("label[name^='employee_name_']").each(function() {
	                   $(this).closest("li").show();
	                });
			}else{
				$("label[name='employee_name_"+groupId+"']").each(function() {
	                   $(this).closest("li").show();
	                });
				 $("label[name^='employee_name_']").not($("label[name='employee_name_"+groupId+"']")).each(function() {
	                   $(this).closest("li").hide();
	                });
			}
			
			$("#collapsevisit_"+groupId).collapse('toggle');
			
			
		}
		
		function showAllEmployee(){
			$("div[id^='collapsevisit_']").collapse('show');
			$("label[name^='employee_name_']").each(function() {
                $(this).closest("li").show();
             });
		}
