...
public class IflytekUtil {
    ...
    // appid
    private static final String APPID = "5e995687";

    // appid对应的secret_key
    private static final String SECRET_KEY = "61857f265959f086d981fa48f05365a1";
    ...
    public static String rtasr(InputStream inputStream) throws Exception {
        ...
        int i=0;
        System.out.println(getCurrentTimeStr() + "\t1");
        ...
        System.out.println(getCurrentTimeStr() + "\t2"+"----"+i);
    ...
    public static class MyWebSocketClient extends WebSocketClient {
        ...
        public void onMessage(String msg) {
            ...
            if (Objects.equals("started", action)) {
                ...
                // 转写结果
            	retMsg=getContent(msgObj.getString("data"));
                System.out.println(getCurrentTimeStr() + "\tresult: " + retMsg);
