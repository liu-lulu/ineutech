...
public class TrucksStyleUtil {
	 ...
	 * 挂车车型:+2
	 */
	private static final String STYLE_2="+2";
	/**
	 * 对应发射器数组,挂车车型类型,+2
	 * 共8个轮胎,
	 * 位置为C1-C8
	 * 对应的发射器号为11-18
	 */
	public static final int[] STYLE_2_ARR={14,13,12,11,18,17,16,15};
	
	/**
	 * 挂车车型:+3
	 */
	private static final String STYLE_3="+3";
	 ...
	 * 对应的发射器号为11-22
	 */
	public static final int[] STYLE_3_ARR={14,13,12,11,18,17,16,15,22,21,20,19};
	...
	public static int TyreNOByWhere(String trucksStyle,String where){
		...
		if(STYLE_4_2_3.equals(trucksStyle)||STYLE_3.equals(trucksStyle)){//车型类型,4*2+3 , +3
			if(t=='A'){//A1--A2
				if(n<=2&&n>0){
		...
		}else if(STYLE_4_2_2.equals(trucksStyle)||STYLE_2.equals(trucksStyle)){//车型类型,4*2+2 ,+2
			if(t=='A'){//A1--A2
				if(n<=2&&n>0){
	...
	public static String TyreWhereByNo(String trucksStyle,int no){
		...
		}else if(STYLE_2.equals(trucksStyle)){//车型类型,+2,胎个数等于8
			if(no<=8){
				return "C"+no;
			}
		}
		else if(STYLE_3.equals(trucksStyle)){//车型类型,+3,胎个数等于12
			if(no<=12){
				return "C"+no;
			}
		}
	...
	public static int noByFasheqiNo(String trucksStyle,int no){
		...
		if(STYLE_4_2_3.equals(trucksStyle)){//车型类型,4*2+3,胎个数等于18
			...
			for(int i=0;i<STYLE_2_ARR.length;i++){
				if(STYLE_2_ARR[i]==no){
					return i+1;
				}
			}
			...
			for(int i=0;i<STYLE_3_ARR.length;i++){
				if(STYLE_3_ARR[i]==no){
					return i+1;
				}
			}
	...
	public static String[] TyreWhereArrByStyle(String trucksStyle){
		...
		if(STYLE_4_2_3.equals(trucksStyle)){//车型类型,4*2+3,胎个数等于18
			...
			return new String[]{"C1","C2","C3","C4","C5","C6","C7","C8","C9","C10","C11","C12"};
		}
		return null;
	}
...
//		return -1;
	...
	public static int TyreMaxNum(String trucksStyle){
		if(STYLE_4_2_3.equals(trucksStyle)){//车型类型,4*2+3,胎个数等于18
			...
			return 14;
		}else if(STYLE_8_4.equals(trucksStyle)||STYLE_3.equals(trucksStyle)){//车型类型,8*4,胎个数等于12
			return 12;
		}else if(STYLE_6_2.equals(trucksStyle)||STYLE_6_2_.equals(trucksStyle)||STYLE_2.equals(trucksStyle)){//车型类型,6*2或6*2+或+2,胎个数等于8
			return 8;
		}else if(STYLE_4_2.equals(trucksStyle)||STYLE_4_2_.equals(trucksStyle)){//车型类型,4*2或4*2+,胎个数等于6
			return 6;
		}else if(STYLE_6_4.equals(trucksStyle)||STYLE_6_4_.equals(trucksStyle)){//车型类型,6*4或6*4+,胎个数等于10
	...
	public static Map<String, Integer> FasheqiPosShowByWeb(String trucksStyle){
		...
		if(STYLE_4_2_3.equals(trucksStyle)){//车型类型,4*2+3,胎个数等于18
			...
			map.put("1", 1);
			map.put("3", 1);
		}else if(STYLE_2.equals(trucksStyle)||STYLE_3.equals(trucksStyle)){//车型类型,+2,+3，没有空位
	...
	/**
	 * web显示,根据车型类型,获取轮胎之间的垂直分割位置
	 * @param trucksStyle 车型类型
	 * @return
	 */
	public static Map<String, Integer> verticalSeparatorByWeb(String trucksStyle){

		Map<String, Integer> map=new HashMap<String, Integer>();
		//map中记录哪个轮胎前需要添加垂直分隔符
		if(STYLE_4_2_3.equals(trucksStyle)||STYLE_4_2_2.equals(trucksStyle)||STYLE_4_2.equals(trucksStyle)||STYLE_4_2_.equals(trucksStyle)||STYLE_6_4.equals(trucksStyle)||STYLE_6_4_.equals(trucksStyle)||STYLE_6_4_3.equals(trucksStyle)){//车型类型,4*2+3,胎个数等于18
			map.put("2", 1);
			map.put("5", 1);
			map.put("9", 1);
			map.put("13", 1);
			map.put("17", 1);
			map.put("21", 1);
		}else if(STYLE_8_4.equals(trucksStyle)||STYLE_6_2.equals(trucksStyle)||STYLE_6_2_.equals(trucksStyle)||STYLE_6_2_3.equals(trucksStyle)){//车型类型,8*4,胎个数等于12
			map.put("2", 1);
			map.put("4", 1);
			map.put("7", 1);
			map.put("11", 1);
			map.put("15", 1);
			map.put("19", 1);
		}else if(STYLE_2.equals(trucksStyle)||STYLE_3.equals(trucksStyle)){//车型类型,+2,+3
			map.put("3", 1);
			map.put("7", 1);
			map.put("11", 1);
		}
	...
	public static void main(String[] args) {
		System.out.println(TyreNOByWhere(STYLE_3, "C1"));
		System.out.println(TyreWhereByFasheqiNo("+3", 22));
		System.out.println(noByFasheqiNo("+2", 15));
		System.out.println(TyreWhereByFasheqiNo("4*2+", 16));
	}
