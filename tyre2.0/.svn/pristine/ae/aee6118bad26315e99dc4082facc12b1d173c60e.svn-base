package com.psylife.hardware.process;
...
import com.psylife.service.impl.DeviceLoginServiceImpl;
...
//	private DeviceLoginLogService deviceLoginLogService=new DeviceLoginLogServiceImpl();
	...
	private DeviceLoginService deviceLoginService=new DeviceLoginServiceImpl();
