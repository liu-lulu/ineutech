...
public class TrucksByAdminVO {
	 ...
	 * 当前挂车
	 */
	private TrucksByAdminVO guache;
	 ...
	 * 胎健康度
	 */
	private Map<String, Float> mapHealth;
	
	/**
	 * 胎花纹深度
	 */
	private Map<String, Float> mapPattern;
	...
	public TrucksByAdminVO getGuache() {
		return guache;
	}

	public void setGuache(TrucksByAdminVO guache) {
		this.guache = guache;
	}
	...
	public Map<String, Float> getMapHealth() {
		return mapHealth;
	}

	public void setMapHealth(Map<String, Float> mapHealth) {
	...
	public Map<String, Float> getMapPattern() {
		return mapPattern;
	}

	public void setMapPattern(Map<String, Float> mapPattern) {
	...
	public String getTrucks_X1() {
		return trucks_X1;
	}

	public void setTrucks_X1(String trucks_X1) {
		this.trucks_X1 = trucks_X1;
	}

	public String getTrucks_Y1() {
		return trucks_Y1;
	}

	public void setTrucks_Y1(String trucks_Y1) {
		this.trucks_Y1 = trucks_Y1;
	}
