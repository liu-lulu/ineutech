...
public class TrucksByTuiJianVO {
	...
	private String trucks_class;
	private String trucks_company;
	
	private List<TyreByTuiJianVO> tyreVOs=new ArrayList<TyreByTuiJianVO>();
	...
	public int getTrucks_flag() {
		return trucks_flag;
	}
	public void setTrucks_flag(int trucks_flag) {
		this.trucks_flag = trucks_flag;
	}
	public String getTrucks_health() {
		return trucks_health;
	}
	public void setTrucks_health(String trucks_health) {
	...
	public String getTrucks_class() {
		return trucks_class;
	}
	public void setTrucks_class(String trucks_class) {
		this.trucks_class = trucks_class;
	}
	public String getTrucks_company() {
		return trucks_company;
	}
	public void setTrucks_company(String trucks_company) {
		this.trucks_company = trucks_company;
	}
	public List<TyreByTuiJianVO> getTyreVOs() {
		return tyreVOs;
	}
	public void setTyreVOs(List<TyreByTuiJianVO> tyreVOs) {
		this.tyreVOs = tyreVOs;
	}
