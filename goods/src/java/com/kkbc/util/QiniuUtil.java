...
public class QiniuUtil {
    ...
    private static String bucketName = "stock";//发布时的存储空间
...
//		if (fileSize>100*1024 && fileSize<=1024*1024) {//100kb~1M
//			return 0.1f;
//		}else if (fileSize>1024*1024 && fileSize<=2*1024*1024) {//1M~2M
//			return 0.1f/2f;
//		}else if (fileSize>2*1024*1024 && fileSize<=3*1024*1024) {//2M~3M
//			return 0.1f/3f;
//		}else if (fileSize>3*1024*1024 && fileSize<=4*1024*1024) {//3M~4M
//			return 0.1f/4f;
//		}
//		return 0.1f;
	}
...
//			}
//		}
    	System.out.println(URLEncoder.encode("7{4HVM5}8]%}BVGO$}XA0C9_ee1c7b01-23ff-47af-8ee1-820ba7155f1b_729ebf60-5a06-4cf4-b707-5add65de3001_768*577.jpg", "UTF-8"));
	}
