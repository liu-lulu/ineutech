...
<body class="login-bg" >
    ...
    <div class="container">  
    <div class="form"> 
    <form class="form-horizontal col-xs-offset-1 col-sm-offset-2 col-md-offset-3" id="loginform" action="login.do" onsubmit="return check();" method="post">
    ...
    <div class="form-group ">
        ...
        <div class="form-item">
            ...
            <input id="e_number" name="e_number" type="text" placeholder="请输入账号" style="width:85%;">
        </div>
        <div class="form-item">
            <label for="password" style="margin-bottom: 15px;">
                <img src="../img/password.png" style="margin-top:0;">
            </label>
            <input id="pwd" name="pwd" type="password" placeholder="请输入密码" style="width:85%;">
        </div>
    </div>
