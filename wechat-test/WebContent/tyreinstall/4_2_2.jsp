<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
	<section class="panel">
<header class="panel-heading"><strong>4×2+2</strong></header>
